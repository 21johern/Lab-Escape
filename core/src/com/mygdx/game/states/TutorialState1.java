...
public class TutorialState1 extends State{
    public static final String TAG = TutorialState1.class.getName();
    public World world;
    ...
    public TutorialState1(GameStateManager stateManager) {
        super(stateManager);
        ...
        map = new TmxMapLoader().load("tutorial.1.tmx");
...
//        cam.update();
        ...
        if (controller.isAtkPressed()) {
            gsm.set(new TutorialState2(gsm));
            dispose();
        }
